  ...
  """
    ...
    def account_for_beds(self, bedcount):
        ...
        if (self.covid == True):
            ...
            occ = bedcount.n_covid_occ + bedcount.n_ncovid_occ if bedcount.n_ncovid_occ is not None else 0;
            free = bedcount.n_covid_free + bedcount.n_ncovid_free  if bedcount.n_ncovid_free is not None else 0;

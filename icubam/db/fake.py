...
def populate_store_fake(store):
  ...
  def add_icu(
    name, dept, city, lat, long, telephone, n_covid_occ, n_covid_free,
  ...
  add_icu(
    'A. Beclere', '92', 'Clamart', 48.788055555555545, 2.2547222222222216,
    'test_tel', 23, 4, 12, 200, 34, 7, 1
  )
  add_icu(
    'A. Pare', '93', 'Unknown', 48.84916666666667, 2.2355555555555555,
    'test_tel', 3, 14, 12, 200, 3, 7, 1
  )

  icu_id = add_icu(
    'Avicenne', '93', 'Bobigny', 48.914722222222224, 2.4241666666666664,
    'test_tel', 12, 23, 12, 200, 34, 12, 1
  )
  ...
  add_icu(
    'Beaujon', '93', 'Bobigny', 48.90833333333333, 2.310277777777777,

...
def main(unused_argv):
  ...
  sdb.upsert_icu('A. Beclere', '92', 'Clamart', 48.788055555555545,
                 2.2547222222222216, 'test_tel')
  sdb.upsert_icu('A. Pare', '93', 'Unknown', 48.84916666666667,
                 2.2355555555555555, 'test_tel')
  sdb.upsert_icu('Avicenne', '93', 'Bobigny', 48.914722222222224,
                 2.4241666666666664, 'test_tel')
  sdb.upsert_icu('Beaujon', '93', 'Bobigny', 48.90833333333333,
                 2.310277777777777, 'test_tel')
  sdb.upsert_icu('Bicetre', '93', 'Kremelin-Bicetre', 48.81, 2.353888888888889,
                 'test_tel')
  ...
  sdb.add_user('Bicetre', 'user1', '+336666666', 'wtf', 'user1@test.org')

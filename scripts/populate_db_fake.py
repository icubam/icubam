...
def main(unused_argv):
  ...
  sdb.update_bedcount(1, 'A. Beclere', 23, 4, 12, 200, 34, 7, 8)
  sdb.update_bedcount(2, 'A. Pare', 3, 14, 12, 200, 3, 7, 9)
  sdb.update_bedcount(3, 'Avicenne', 12, 23, 12, 200, 34, 12, 6)
  sdb.update_bedcount(4, 'Beaujon', 5, 6, 12, 200, 34, 7, 5)
  sdb.update_bedcount(5, 'Bicetre', 9, 2, 12, 200, 34, 44, 10)
